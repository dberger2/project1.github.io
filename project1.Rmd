...
At this point, we have a usable data frame to start cleaning up a bit more.  Some of the column names were a bit long, so the following code was used to turn them into something a little more readable.
